#Tests for mini_jeopardy.py
#Author: Christine Chen

import mini_jeopardy
from datetime import datetime

#TODO: Is there a better way to work with test data? 
...
#TESTING COLLECTION 1: GETTING CLUES

#Test 1: Check that calling get_clues() with the correct parameters
#results in 19 clues (20 - 1 final jeopardy clue) where the clues all aired in 1964
def collection_1_test_1():
    ...
    #count the clues
    num_clues = 0
    #track whether or not there is an invalid air date
...
def collection_1_test_3():
    ...
    #data to verify that the test logic is correct. For the first clue set, the clues are in descending order. For the
    #second clue set, there are two clues that have the same value.
...
#TESTING COLLECTION 2: USER INPUT
...
#Test 3: Check that calling check_input() with an invalid value
...
#helper methods to cut down on repetitive print statements
...
print('\nCOLLECTION 1:GETTING CLUES\n')
collection_1_test_1()
collection_1_test_2()
collection_1_test_3()
print('\nCOLLECTION 2:USER INPUT\n')
collection_2_test_1()
collection_2_test_2()
collection_2_test_3()
